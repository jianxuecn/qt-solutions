...
{
    QList<QtIntPropertyManager *> intPropertyManagers = manager->findChildren<QtIntPropertyManager *>();//qFindChildren<QtIntPropertyManager *>(manager);
    QListIterator<QtIntPropertyManager *> itInt(intPropertyManagers);
    while (itInt.hasNext())
        d_ptr->m_spinBoxFactory->addPropertyManager(itInt.next());

    QList<QtDoublePropertyManager *> doublePropertyManagers = manager->findChildren<QtDoublePropertyManager *>();//qFindChildren<QtDoublePropertyManager *>(manager);
    ...
    QList<QtBoolPropertyManager *> boolPropertyManagers = manager->findChildren<QtBoolPropertyManager *>();//qFindChildren<QtBoolPropertyManager *>(manager);
    ...
    QList<QtStringPropertyManager *> stringPropertyManagers = manager->findChildren<QtStringPropertyManager *>();//qFindChildren<QtStringPropertyManager *>(manager);
    ...
    QList<QtDatePropertyManager *> datePropertyManagers = manager->findChildren<QtDatePropertyManager *>();//qFindChildren<QtDatePropertyManager *>(manager);
    ...
    QList<QtTimePropertyManager *> timePropertyManagers = manager->findChildren<QtTimePropertyManager *>();//qFindChildren<QtTimePropertyManager *>(manager);
    ...
    QList<QtDateTimePropertyManager *> dateTimePropertyManagers = manager->findChildren<QtDateTimePropertyManager *>();//qFindChildren<QtDateTimePropertyManager *>(manager);
    ...
    QList<QtKeySequencePropertyManager *> keySequencePropertyManagers = manager->findChildren<QtKeySequencePropertyManager *>();//qFindChildren<QtKeySequencePropertyManager *>(manager);
    ...
    QList<QtCharPropertyManager *> charPropertyManagers = manager->findChildren<QtCharPropertyManager *>();//qFindChildren<QtCharPropertyManager *>(manager);
    ...
    QList<QtLocalePropertyManager *> localePropertyManagers = manager->findChildren<QtLocalePropertyManager *>();//qFindChildren<QtLocalePropertyManager *>(manager);
    ...
    QList<QtPointPropertyManager *> pointPropertyManagers = manager->findChildren<QtPointPropertyManager *>();//qFindChildren<QtPointPropertyManager *>(manager);
    ...
    QList<QtPointFPropertyManager *> pointFPropertyManagers = manager->findChildren<QtPointFPropertyManager *>();//qFindChildren<QtPointFPropertyManager *>(manager);
    ...
    QList<QtSizePropertyManager *> sizePropertyManagers = manager->findChildren<QtSizePropertyManager *>();//qFindChildren<QtSizePropertyManager *>(manager);
    ...
    QList<QtSizeFPropertyManager *> sizeFPropertyManagers = manager->findChildren<QtSizeFPropertyManager *>();//qFindChildren<QtSizeFPropertyManager *>(manager);
    ...
    QList<QtRectPropertyManager *> rectPropertyManagers = manager->findChildren<QtRectPropertyManager *>();//qFindChildren<QtRectPropertyManager *>(manager);
    ...
    QList<QtRectFPropertyManager *> rectFPropertyManagers = manager->findChildren<QtRectFPropertyManager *>();//qFindChildren<QtRectFPropertyManager *>(manager);
    ...
    QList<QtColorPropertyManager *> colorPropertyManagers = manager->findChildren<QtColorPropertyManager *>();//qFindChildren<QtColorPropertyManager *>(manager);
    ...
    QList<QtEnumPropertyManager *> enumPropertyManagers = manager->findChildren<QtEnumPropertyManager *>();//qFindChildren<QtEnumPropertyManager *>(manager);
    ...
    QList<QtSizePolicyPropertyManager *> sizePolicyPropertyManagers = manager->findChildren<QtSizePolicyPropertyManager *>();//qFindChildren<QtSizePolicyPropertyManager *>(manager);
    ...
    QList<QtFontPropertyManager *> fontPropertyManagers = manager->findChildren<QtFontPropertyManager *>();//qFindChildren<QtFontPropertyManager *>(manager);
    ...
    QList<QtCursorPropertyManager *> cursorPropertyManagers = manager->findChildren<QtCursorPropertyManager *>();//qFindChildren<QtCursorPropertyManager *>(manager);
    ...
    QList<QtFlagPropertyManager *> flagPropertyManagers = manager->findChildren<QtFlagPropertyManager *>();//qFindChildren<QtFlagPropertyManager *>(manager);
